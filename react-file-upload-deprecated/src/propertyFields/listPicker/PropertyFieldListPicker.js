...
const PropertyFieldListPickerHost_1 = require("./PropertyFieldListPickerHost");
const PropertyFieldListMultiPickerHost_1 = require("./PropertyFieldListMultiPickerHost");
/**
...
class PropertyFieldListPickerBuilder {
    ...
    render(elem, ctx, changeCallback) {
        ...
        if (this.multiSelect) {
            ...
            const element = React.createElement(PropertyFieldListMultiPickerHost_1.default, componentProps);
            ...
            const element = React.createElement(PropertyFieldListPickerHost_1.default, componentProps);
            // Calls the REACT content generator
            ReactDom.render(element, elem);
        }
    }
