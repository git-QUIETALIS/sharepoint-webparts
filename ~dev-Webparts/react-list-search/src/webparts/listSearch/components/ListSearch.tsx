...
export default class IListdSearchWebPart extends React.Component<IListSearchProps, IListSearchState> {
  ...
  public checkForDefaultIcons() {
    ...
    // Check if default file icon is currently in use
    let defaultSPIcon = $("img[src$='https://spoprod-a.akamaihd.net/files/fabric/assets/item-types/16/spo.png']");
    if (defaultSPIcon.length > 0) {
      // Change the default file icon
      console.log("Default icon found, changing it");
