define("1c4541f7-5c31-41aa-9fa8-fbc9dc14c0a8_1.4.0", ["@microsoft/sp-core-library","@ms/sp-telemetry","@microsoft/sp-http"], (function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_13__, __WEBPACK_EXTERNAL_MODULE_16__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var SPTimeZone = (function () {
    ...
    SPTimeZone.prototype._validate = function (data) {
        sp_core_library_1.Validate.isNotNullOrUndefined(data, 'ISPTimeZoneData object');
        sp_core_library_1.Validate.isNotNullOrUndefined(data.daylightDate, 'daylightDate');
        sp_core_library_1.Validate.isNotNullOrUndefined(data.daylightOffset, 'daylightOffset');
        sp_core_library_1.Validate.isNotNullOrUndefined(data.description, 'description');
        sp_core_library_1.Validate.isNotNullOrUndefined(data.id, 'id');
        sp_core_library_1.Validate.isNotNullOrUndefined(data.offset, 'offset');
        sp_core_library_1.Validate.isNotNullOrUndefined(data.standardDate, 'standardDate');
        sp_core_library_1.Validate.isNotNullOrUndefined(data.standardOffset, 'standardOffset');
    };
    return SPTimeZone;
}());
exports.default = SPTimeZone;
...
Object.defineProperty(exports, "__esModule", { value: true });
var sp_telemetry_1 = __webpack_require__(13);
var sp_core_library_1 = __webpack_require__(0);
var SPWeb_1 = __webpack_require__(4);
var SPList_1 = __webpack_require__(5);
var SPListItem_1 = __webpack_require__(6);
var SPSite_1 = __webpack_require__(7);
var SPUser_1 = __webpack_require__(9);
var CultureInfo_1 = __webpack_require__(10);
...
Object.defineProperty(exports, "__esModule", { value: true });
var sp_core_library_1 = __webpack_require__(0);
var SPPermission_1 = __webpack_require__(1);
var SPTimeZone_1 = __webpack_require__(2);
var SPWeb = (function () {
    function SPWeb(data) {
        this._validate(data);
        ...
        this._permissions = new SPPermission_1.default(data.permissions);
        this._timeZone = data.timeZoneInfo ?
            new SPTimeZone_1.default(data.timeZoneInfo) : undefined;
...
Object.defineProperty(exports, "__esModule", { value: true });
var sp_core_library_1 = __webpack_require__(0);
var O365GroupAssociation_1 = __webpack_require__(8);
var SPSite = (function () {
...
})(O365GroupAssociationType = exports.O365GroupAssociationType || (exports.O365GroupAssociationType = {}));
var O365GroupAssociation = (function () {
    ...
    O365GroupAssociation.prototype._validate = function (data) {
        sp_core_library_1.Validate.isNotNullOrUndefined(data, 'IO365GroupData object');
        sp_core_library_1.Validate.isNotNullOrUndefined(data.id, 'data.id');
    };
    return O365GroupAssociation;
}());
exports.default = O365GroupAssociation;
...
Object.defineProperty(exports, "__esModule", { value: true });
var sp_http_1 = __webpack_require__(16);
...
Object.defineProperty(exports, "__esModule", { value: true });
var PageContext_1 = __webpack_require__(3);
...
var SPField_1 = __webpack_require__(14);
exports.SPField = SPField_1.default;
var SPList_1 = __webpack_require__(5);
...
var O365GroupAssociation_1 = __webpack_require__(8);
exports.O365GroupAssociation = O365GroupAssociation_1.default;
exports.O365GroupAssociationType = O365GroupAssociation_1.O365GroupAssociationType;
var SPPermission_1 = __webpack_require__(1);
exports.SPPermission = SPPermission_1.default;
var PageManager_1 = __webpack_require__(15);
exports.PageManager = PageManager_1.default;
var SharePointPageContextDataProvider_1 = __webpack_require__(11);
exports.SharePointPageContextDataProvider = SharePointPageContextDataProvider_1.default;
var SPTimeZone_1 = __webpack_require__(2);
exports.SPTimeZone = SPTimeZone_1.default;
...
var SPField = (function () {
    function SPField(data) {
        this._validate(data);
        this._id = sp_core_library_2.Guid.parse(data.id);
        this._internalName = data.internalName || '';
        this._fieldType = data.fieldType || '';
        this._required = data.isRequired;
        this._displayName = data.displayName || '';
        this._clientSideComponentId = sp_core_library_2.Guid.tryParse(data.clientSideComponentId);
    ...
    SPField.prototype._validate = function (data) {
        sp_core_library_1.Validate.isNotNullOrUndefined(data, 'ISPFieldData object');
    };
    return SPField;
}());
exports.default = SPField;
